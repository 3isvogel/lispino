...
# # Remove references to source when logging
# CFLAGS += -DLOG_NO_SOURCE_POSITION

# # Remove special charaters in logging (Useful when using terminals that do not
#   support them
# CFLAGS += -DLOG_DISABLE_COLOR
